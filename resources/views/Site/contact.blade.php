            ...
            <div class="row align-items-center gap-y">
                ...
                <div class="col-md-5 ml-md-auto">
                    <div class="section-heading">
                        <p class="small bold badge badge-info">Reach out to us</p>
                    ...
                    <div class="media"><i class="fas fa-envelope font-l color-3 mr-3"></i>
                        <div class="media-body"><a href="mailto:support@vybbz.com">support@vybbz.com</a></div>
                    </div>
                    <hr class="my-4">
    ...
    <section class="section b-b">
        <div class="container">
            <div class="row gap-y align-items-center text-center text-lg-left">
                <div class="col-12 col-md-6 py-4 px-5 b-md-r"><i class="pe pe-7s-cash pe-3x color-2"></i> <a href="javascript:;" class="mt-4 color-2 d-flex align-items-center"><h4 class="mr-3">Contact Sales</h4><i class="fas fa-long-arrow-alt-right"></i></a>
                    <p class="mt-4">Looking for a custom quote? need to tell us more about your project? or want a demonstration? drop us a line to <a href="mailto:support@vybbz.com">sales@vybbz.com</a></p>
                </div>
                <div class="col-12 col-md-6 py-4 px-5"><i class="pe pe-7s-help2 pe-3x color-2"></i> <a href="javascript:;" class="mt-4 color-2 d-flex align-items-center"><h4 class="mr-3">Technical Support</h4><i class="fas fa-long-arrow-alt-right"></i></a>
                    <p class="mt-4">Any question about how to integrate your product?. Don't fret, our geek team is ready for you at <a href="mailto:support@vybbz.com">support@vybbz.com</a></p>
                </div>
            </div>
        </div>
    </section>
